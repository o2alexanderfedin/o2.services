...
/**
 * The eight states, each reached from an input — AUTH-06, plan `42-04`.
 *
 * The value of this file is not that eight branches return eight values. It is the two
...
describe('signinState — the eight states a visitor can be in', () => {
...
describe('the two orderings that must not be reachable', () => {
  /**
