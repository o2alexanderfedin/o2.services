...
**The 31 unchecked boxes are 12 + 18 + 1**, and the three markers are not one label:
12 are *Built, not wired*, 18 are *Partial*, and VER-02 alone is *Not started*.
