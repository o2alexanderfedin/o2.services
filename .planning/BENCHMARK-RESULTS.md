...
- **AMENDED 2026-08-25 — the two BENCH-06 entries above stand as measurements and their *reason* does not.** They read that one machine *was available*, which was true of the day they were taken and reads now as a hardware limit. It is not one. `PROJECT.md` records the owner's statement of 2026-08-24 — a few hundred willing testers across countries and continents, available as soon as there is something to give them access to — so **what was missing was access, not a machine**, and the cohort is spread across continents rather than being more hardware in one room. Public since 2026-07-26 and open source by the ruling of 2026-08-24, so disclosure gates nothing either. The distinct-machine half stays NOT MET, unchanged and for the unchanged reason that it is unmeasured; its named closer is **Phase 39 criterion 4**, and until that run reports, no same-host figure in this document may be published in its place.
