...
**A consequence the plans do not yet cover, raised rather than assumed:** all five of this phase's criteria are checked against the *store's contents*, none against anything a person can see. "Show it at the presentation" needs a visible surface, and no plan carries one. Costed and decided before execution, not discovered at the presentation.
**Success Criteria** (what must be TRUE):
