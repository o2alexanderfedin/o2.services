...
| **The funnel reaches its collector** | NO-GO | A staged invite is read between stages or it is not staged at all. Blocker: plan 39-02's probe-before-targeting, and the pre-invite reading of step 2 of `.planning/phases/phase-37-the-six-stage-funnel-and-a-frozen-telemetry-schema/37-RUNBOOK.md` |
